	    ...
	    <div class="row">
			<div class="col-md-2 user-sidebar">
				...
				<div class="list-group" style="margin-top: 20px;">
					<a href="<?php echo base_url('admin/hospital') ?>" class="list-group-item <?php echo active_link_method('hospital', 'admin') ?>">
						<i class="fa fa-bed"></i> Data Hospital
					</a>
					<a href="<?php echo base_url('admin/addhospital') ?>" class="list-group-item <?php echo active_link_method('addhospital', 'admin') ?>">
